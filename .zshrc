...
plugins=(catimg colored-man-pages colorize command-not-found frontend-search fzf git heroku npm systemd vi-mode vscode yarn z)
...
source ~/dotfiles/etc/zsh-syntax-highlighting/zsh-syntax-highlighting.sh
